...
st.text("入力パラメーターは、年金の支払い期間と受給期間、日本の金利、海外での投資リターン、為替レート、また、支払い期間と受給期間を除く各パラメーターの標準偏差です。これらのインプットをもとに、国民年金の現在価値と投資の価値の平均値、そして年金が投資を上回る確率を計算します。")

st.markdown(":small[このシミュレーターでは、国民年金の月々の支払額は2025年度の17,510円、満額受給額は831,700円として計算しています。また、障害年金と遺族年金、手数料については考慮していません。]")
